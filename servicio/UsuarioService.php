...
class UsuarioService
{
	...
	public function consultarLogin($nombreUsuario, $clave) 
	{
		...
		$stm = $pdo->prepare("SELECT u.*, td.codigo, td.descripcion FROM tbl_usuarios u INNER JOIN tbl_tipos_documentos td ON u.tipo_documento_id = td.id WHERE u.nombre_usuario = :nombreUsuario AND u.clave = :clave");
	...
	public function registrarUsuario($usuario){
		...
		$stm -> bindValue(":numeroDocumento", $usuario->getNumeroDocumento(),PDO::PARAM_INT);
...
//convertir una fila a un objeto - se recibe como parametro de entrada una fila

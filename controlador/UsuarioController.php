...
class UsuarioController
{
	...
	public function listar(){
		...
		//Conexion a la vista 
		self::$template->render(DIR_VIEW."usuario/lista.php", ["titulo"=>"Usuarios - Lista", "usuarios" => $usuarios]);
	}

	public function registro(){
		$tiposDocumentos = self::$tdServicio -> consultarTodos();

		self::$template->render(DIR_VIEW."usuario/registro.php", ["titulo"=>"Usuarios - Registro", "tiposDocumentos"=>$tiposDocumentos]);	
	}

	public function registrar(){
		//Recuperar los datos--- armar el objeto Usuario y pasarlo
		$usuario = new Usuario();
